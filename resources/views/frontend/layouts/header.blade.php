            ...
            <div class="row d-flex align-items-center">
                <div class="col-xl-6 offset-xl-1 col-lg-6 offset-lg-1 col-md-7 offset-md-1">
                    <div class="header-info">
                        ...
                        <span><i class="fas fa-envelope"></i> <a href="https://wphix.com/cdn-cgi/l/email-protection"
                                class="__cf_email__"
                                data-cfemail="147d7a727b54716c75796478713a777b79">[email&#160;protected]</a></span>
                    </div>
                </div>
