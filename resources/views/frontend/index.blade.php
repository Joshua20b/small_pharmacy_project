        ...
        <div class="row">
            <div class="col-xl-6 col-lg-5">
                <div class="medical-icon-brand-2">
                    </frontend/img src="/frontend/img/about/medical-brand-icon-border.png" alt="">
                </div>
                <div class="about-left-side pos-rel mb-30">
                    <div class="about-front-/frontend/img">
                        </frontend/img src="/frontend/img/about/about-/frontend/img.jpg" alt="">
                    </div>
                    <div class="about-shape">
                        </frontend/img src="/frontend/img/about/about-shape.png" alt="">
                    </div>
                </div>
            </div>
                ...
                <div class="about-right-side pt-55 mb-30">
                    ...
                    <div class="about-author d-flex align-items-center">
                        <div class="author-ava">
                            </frontend/img src="/frontend/img/about/author-ava.png" alt="">
                        </div>
    ...
    <div class="container">
            ...
            <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                <div class="section-title text-center pos-rel mb-75">
                    <div class="section-icon">
                        </frontend/img class="section-back-icon" src="/frontend/img/section/section-back-icon.png" alt="">
                    </div>
                    ...
                    <div class="section-line pos-rel">
                        </frontend/img src="/frontend/img/shape/section-title-line.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="service-box text-center mb-30">
                    <div class="service-thumb">
                        </frontend/img src="/frontend/img/services/service1.png" alt="">
                    </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="service-box text-center mb-30">
                    <div class="service-thumb">
                        </frontend/img src="/frontend/img/services/service2.png" alt="">
                    </div>
                    <div class="service-content">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="service-box text-center mb-30">
                    <div class="service-thumb">
                        </frontend/img src="/frontend/img/services/service3.png" alt="">
                    </div>
                    <div class="service-content">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="service-box text-center mb-30">
                    <div class="service-thumb">
                        </frontend/img src="/frontend/img/services/service4.png" alt="">
                    </div>
                    <div class="service-content">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="service-box text-center mb-30">
                    <div class="service-thumb">
                        </frontend/img src="/frontend/img/services/service5.png" alt="">
                    </div>
                    <div class="service-content">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="service-box text-center mb-30">
                    <div class="service-thumb">
                        </frontend/img src="/frontend/img/services/service6.png" alt="">
                    </div>
                    <div class="service-content">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-lg-7 col-md-10">
                <div class="section-title pos-rel mb-75">
                    <div class="section-icon">
                        </frontend/img class="section-back-icon back-icon-left" src="/frontend/img/section/section-back-icon.png" alt="">
                    </div>
                    <div class="section-text pos-rel">
                        <h5>Our Team</h5>
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="team-box text-center mb-60">
                    <div class="team-thumb mb-45 pos-rel">
                        </frontend/img src="/frontend/img/team/member1.png" alt="">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="team-box text-center mb-60">
                    <div class="team-thumb mb-45 pos-rel">
                        </frontend/img src="/frontend/img/team/member2.png" alt="">
                        <a class="team-link" href="doctor-details.html">+</a>
                    </div>
                    <div class="team-content">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="team-box text-center mb-60">
                    <div class="team-thumb mb-45 pos-rel">
                        </frontend/img src="/frontend/img/team/member3.png" alt="">
                        <a class="team-link" href="doctor-details.html">+</a>
                    </div>
                    <div class="team-content">
                        <h3>Hulk M. Kenbon</h3>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="team-box text-center mb-60">
                    <div class="team-thumb mb-45 pos-rel">
                        </frontend/img src="/frontend/img/team/member4.png" alt="">
                        <a class="team-link" href="doctor-details.html">+</a>
                    </div>
                    <div class="team-content">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="team-box text-center mb-60">
                    <div class="team-thumb mb-45 pos-rel">
                        </frontend/img src="/frontend/img/team/member5.png" alt="">
                        <a class="team-link" href="doctor-details.html">+</a>
                    </div>
                    <div class="team-content">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="team-box text-center mb-60">
                    <div class="team-thumb mb-45 pos-rel">
                        </frontend/img src="/frontend/img/team/member6.png" alt="">
                        <a class="team-link" href="doctor-details.html">+</a>
                    </div>
                    <div class="team-content">
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="pricing-box mb-30">
                                    <div class="pricing-thumb mb-45">
                                        </frontend/img src="/frontend/img/pricing/pricing-thumb-1.png" alt="">
                                    </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="pricing-box mb-30">
                                    <div class="pricing-thumb mb-45">
                                        </frontend/img src="/frontend/img/pricing/pricing-thumb-2.png" alt="">
                                    </div>
                                    <div class="pricing-content">
                                        <h1>Advanced</h1>
                                        <p>Ut enim ad minim veniam, quis istomw nostrud exercitation ullamco
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="pricing-box mb-30">
                                    <div class="pricing-thumb mb-45">
                                        </frontend/img src="/frontend/img/pricing/pricing-thumb-3.png" alt="">
                                    </div>
                                    <div class="pricing-content">
                                        <h1>Advantage</h1>
                                        <p>Ut enim ad minim veniam, quis istomw nostrud exercitation ullamco
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="latest-news-box mb-30">
                    <div class="latest-news-thumb mb-35">
                        </frontend/img src="/frontend/img/blog/blog-thumb-1.jpg" alt="">
                    </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="latest-news-box mb-30">
                    <div class="latest-news-thumb mb-35">
                        </frontend/img src="/frontend/img/blog/blog-thumb-2.jpg" alt="">
                    </div>
                    <div class="latest-news-content">
                        <div class="news-meta mb-10">
                            <span><a href="#" class="news-tag">Medical,</a></span>
